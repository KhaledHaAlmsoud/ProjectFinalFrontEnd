    ...
    <div>
      ...
      <div className="vh-100 d-flex text-light justify-content-center align-items-center ">
        <div
          ...
          className=" p-2 col-md-3 bg-dark text-center pt-3  "
        >
          <h4>E-mail</h4>
          <input
          ...
          <input
            ...
            className=" m-auto mb-5 form-control w-75 m-3"
          />
          <button
            className=" btn btn-info px-5 fw-bold py-1"
            onClick={() => {
              addUser();
            }}
          >
          ...
          <Link to="/SignUp">
            {" "}
            <p className="mt-5 mb-5 ,  btn btn-info px-5 fw-bold py-1 ">
              {" "}
              new registration{" "}
            </p>
          </Link>
