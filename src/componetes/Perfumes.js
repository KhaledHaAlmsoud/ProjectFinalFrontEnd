...
export default function Perfumes({ token, userId }) {
    ...
    useEffect(async () => {
      try {
        const result = await axios.get("http://localhost:5000/Perfumes");
    ...
    return (
      <div>
        ...
        <div className="continer">
          {perfumes && perfumes.map((element, i) => {
            return (
              <div onClick={()=>{toPerfumes(element._id)}} className="boxproduct">
