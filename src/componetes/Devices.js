...
export default function Devices({token,userId}) {
    ...
    return (
      <div>
        ...
        <div className="continer">
          {devices && devices.map((element, i) => {
            return (
              <div onClick={()=>{toDevice(element._id)}} className="boxproduct">
